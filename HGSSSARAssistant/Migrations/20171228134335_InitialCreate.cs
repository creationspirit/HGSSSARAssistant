        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Magnitude = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<long>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    DaysInWeek = table.Column<string>(nullable: true),
                    EndTime = table.Column<DateTime>(nullable: false),
                    LocationID = table.Column<long>(nullable: true),
                    RescuerId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Availabilities_AspNetUsers_RescuerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RescuerActions", x => x.ID);
                    table.ForeignKey(
                        name: "FK_RescuerActions_Actions_ActionID",
                        column: x => x.ActionID,
                        principalTable: "Actions",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RescuerActions_AspNetUsers_RescuerId",
                        column: x => x.RescuerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RescuerSkills", x => x.ID);
                    table.ForeignKey(
                        name: "FK_RescuerSkills_AspNetUsers_RescuerId",
                        column: x => x.RescuerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RescuerSkills_Skills_SkillID",
                        column: x => x.SkillID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_RescuerId",
                table: "Availabilities",
                column: "RescuerId");

            migrationBuilder.CreateIndex(
                name: "IX_RescuerActions_ActionID",
                table: "RescuerActions",
                column: "ActionID");

            migrationBuilder.CreateIndex(
                name: "IX_RescuerActions_RescuerId",
                table: "RescuerActions",
                column: "RescuerId");

            migrationBuilder.CreateIndex(
                name: "IX_RescuerSkills_RescuerId",
                table: "RescuerSkills",
                column: "RescuerId");

            migrationBuilder.CreateIndex(
                name: "IX_RescuerSkills_SkillID",
                table: "RescuerSkills",
                column: "SkillID");
